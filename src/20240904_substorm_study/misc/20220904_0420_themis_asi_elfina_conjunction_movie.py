...
location_codes = ('ATHA', 'PINA', 'GILL', 'TPAS', 'KAPU')
themis_probes = ('a', 'd', 'e')
alt=110
...
ax = asilib.map.create_map(lon_bounds=(-120, -85), lat_bounds=(41, 65), fig_ax=(fig, gs[:, 0]))
bx = fig.add_subplot(gs[0, 1])
cx = fig.add_subplot(gs[1, 1], sharex=bx, sharey=bx)

plt.suptitle(f'THEMIS-THEMIS ASI-ELFIN Conjunction | {time_range[0][:10]} | T89 model | {alt} km map altitude')
