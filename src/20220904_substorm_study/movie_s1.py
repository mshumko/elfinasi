...
time_range = ('2022-09-04T04:00:00', '2022-09-04T04:40:00')
location_codes = ('ATHA', 'GILL', 'RABB', 'LUCK', 'PINA')  # 'RANK'
alt=110

fig = plt.figure(figsize=(6, 5))
ax = asilib.map.create_map(lon_bounds=(-120, -85), lat_bounds=(44, 62), fig_ax=(fig, 111), land_color='grey')
...
ax.set_title(f'TREx-RGB | {time_range[0][:10]} | {alt} km map altitude')
